...
public class Rect {
	...
	public Rect(int color){
		...
		switch(color){
			case 1: 
				this.x[0]=5 ;this.x[1]=4 ;this.x[2]=6 ;this.x[3]=7 ;	//string
				this.y[0]=-1;this.y[1]=-1;this.y[2]=-1;this.y[3]=-1; 
				break;
			case 2: 
				this.x[0]=5 ;this.x[1]=4 ;this.x[2]=6 ;this.x[3]=5 ;	//Õ¡
				this.y[0]=-1;this.y[1]=-1;this.y[2]=-1;this.y[3]=0; 
				break;
			case 3: 
				this.x[0]=5 ;this.x[1]=4 ;this.x[2]=5 ;this.x[3]=4 ;	//ÃÔ
				this.y[0]=-1;this.y[1]=-1;this.y[2]=0 ;this.y[3]=0 ; 
				break;
			case 4: 
				this.x[0]=5 ;this.x[1]=4 ;this.x[2]=6 ;this.x[3]=6 ;	//right L
				this.y[0]=-1;this.y[1]=-1;this.y[2]=-1;this.y[3]=0; 
				break;
			case 5: 
				this.x[0]=5 ;this.x[1]=4 ;this.x[2]=6 ;this.x[3]=4;	//left L
				this.y[0]=-1;this.y[1]=-1;this.y[2]=-1;this.y[3]=0; 
				break;
			case 6: 
				this.x[0]=5 ;this.x[1]=6 ;this.x[2]=5 ;this.x[3]=4;	//Z
				this.y[0]=-1;this.y[1]=-1;this.y[2]=0;this.y[3]=0; 
				break;
			case 7: 
				this.x[0]=5 ;this.x[1]=4 ;this.x[2]=5 ;this.x[3]=6;	// oppsive Z
				this.y[0]=-1;this.y[1]=-1;this.y[2]=0;this.y[3]=0; 
				break;
		}
	}
