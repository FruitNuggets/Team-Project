...
public class CreateAccountPanel extends JPanel
{
  ...
  public CreateAccountPanel(CreateAccountControl lc)
  {
    ...
    JLabel instruction2Label = new JLabel("Your password must be at least 6 characters.", JLabel.CENTER);
    labelPanel.add(errorLabel);
    labelPanel.add(instructionLabel);
    labelPanel.add(instruction2Label);

    // Create a panel for the login information form.
    JPanel loginPanel = new JPanel(new GridLayout(3, 3, 5, 5));
    JLabel usernameLabel = new JLabel("Username:", JLabel.RIGHT);
    usernameField = new JTextField(10);
    JLabel passwordLabel = new JLabel("Password:", JLabel.RIGHT);
    passwordField = new JPasswordField(10);
    JLabel verifyLabel = new JLabel("Verify Password:", JLabel.RIGHT);
    verifyField = new JPasswordField(10);
